...
<head>
    ...
    <script>
        ...
        function updateNetworkSettings() {
            ...
            const staticNetworkMask = document.getElementById('static-network-mask').value;
                    ...
                    <div class='card'>
                        ...
                        <div class='card-body'>
                            <div class='form-group'>
                                ...
                                <input type='text' class='form-control' id='static-ip' placeholder='192.168.2.9'>
                            </div>
                            <div class='form-group'>
                                <label for='static-ip'>Network Mask:</label>
                                <input type='text' class='form-control' id='static-network-mask' placeholder='255.255.255.0'>
                            </div>
                            <div class='form-group'>
                                <label for='static-gateway'>Gateway:</label>
                                <input type='text' class='form-control' id='static-gateway' placeholder='192.168.2.1'>
                            </div>
                        </div>
