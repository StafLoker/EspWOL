        ...
        function getNetworkSettings() {
            fetch('/network_settings')
                ...
                .then(data => {
                    ...
                    document.getElementById('fieldStaticIP').value = data.staticIP;
                    document.getElementById('fieldNetworkMask').value = data.staticNetworkMask;
                    document.getElementById('fieldStaticGateway').value = data.staticGateway;
                })
                    ...
                    <div class='card'>
                        ...
                        <div class='card-body'>
                            ...
                            <div class='form-group'>
                                ...
                                <input type='text' class='form-control' id='fieldStaticIP' placeholder='192.168.2.9'>
                            </div>
                            <div class='form-group'>
                                <label for='static-ip'>Network Mask:</label>
                                <input type='text' class='form-control' id='fieldNetworkMask' placeholder='255.255.255.0'>
                            </div>
                            <div class='form-group'>
                                <label for='static-gateway'>Gateway:</label>
                                <input type='text' class='form-control' id='fieldStaticGateway' placeholder='192.168.2.1'>
                            </div>
                        </div>
