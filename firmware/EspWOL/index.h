          ...
          .then((data) => {
            ...
            data.forEach((pc, index) => {
              pcList.innerHTML +=
                ...
                '<div class="status-circle" id="status-' +
                index +
                '"></div>' +
                pc.name +
                " - " +
                ...
                index +
                '" class="btn btn-info btn-md mr-2" onclick="pingPC(\'' +
                pc.ip +
                "', " +
                index +
                ')"><i class="fas fa-table-tennis"></i></button>' +
                '<button class="btn btn-warning btn-md mr-2" onclick="editPC(' +
                index +
                ')"><i class="fas fa-edit"></i></button>' +
                '<button class="btn btn-primary btn-md" onclick="wakePC(\'' +
                pc.mac +
      ...
      <h2 class="mt-4 d-flex justify-content-between align-items-center">
        ...
        <div class="ml-auto">
          ...
          <button
            ...
            onclick="getNetworkSettings(); getAuthentication(); getAbout();"
          >
            ...
            <div class="card">
              ...
              <div class="card-footer">
                ...
                <button
                  ...
                  title="Reset WiFi"
                  data-toggle="modal"
                  data-target="#reset-wifi-modal"
                  onclick="$('#settings-modal').modal('hide');"
                >
                  Reset WiFi
                </button>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              class="btn btn-secondary"
              data-dismiss="modal"
              onclick="$('#settings-modal').modal('show');"
            >
              Cancel
            </button>
          </div>
